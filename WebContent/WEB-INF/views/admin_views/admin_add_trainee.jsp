...
<body>
	...
	<h1 class="m--1 g--4 g-s--11 docsHeader">Add Trainee</h1>
	</header> 
	...
	<div class="g--10 m--1">
		...
		<form action="registerTrainee" method="POST">
			...
			<div id="select_location">
				<label style="display: block;">Trainee Status</label> <select
					name="status">
					<option value="IN_TRAINING">IN_TRAINING</option>
					<option value="SIGNED_OFF">SIGNED_OFF</option>
					<option value="BEACHED">BEACHED</option>
				</select>
			</div>
			...
			<div id="select_date">
				<label style="display: block;">End date:</label> <input
					type="date" 
					required
					pattern="(?:19|20)[0-9]{2}-(?:(?:0[1-9]|1[0-2])-(?:0[1-9]|1[0-9]|2[0-9])|(?:(?!02)(?:0[1-9]|1[0-2])-(?:30))|(?:(?:0[13578]|1[02])-31))"
					title="Enter a date in this format YYYY/MM/DD" name="endTime"
					placeholder="YYYY-MM-DD" />
			</div>
